...
<body>
	<div id="index_layout">
		...
		<div data-options="region:'west',href:'${ctx}/layout/west.jsp',split:true" title="模块导航" style="width: 200px; overflow: hidden;"></div>
		<div data-options="region:'center'" title="财富资讯后台管理系统" style="overflow: hidden;">
			<div id="index_tabs" style="overflow: hidden;">
			<div class="easyui-tab" title="首页" href="<c:url value="/portal/about.jsp"/>" style="padding:2px; overflow: hidden;">
			</div>
			</div>
		</div>
		<%--  <div data-options="region:'east',href:'${ctx}/layout/east.jsp'" title="当前时间" style="width: 230px; overflow: hidden;"></div>  --%>
