...
/**
 * SysJobInfo entity. @author MyEclipse Persistence Tools
 */
@Entity
@DynamicUpdate(true)
@DynamicInsert(true)
...
public class SysJobInfo implements java.io.Serializable {
	...
	@Transient
	public String getSjiNameV() {
		return sjiNameV;
	}

	public void setSjiNameV(String sjiNameV) {
		this.sjiNameV = sjiNameV;
	}
