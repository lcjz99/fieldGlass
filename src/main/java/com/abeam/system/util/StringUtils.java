...
public class StringUtils extends org.apache.commons.lang.StringUtils {
	...
	/**
	 * 
	 * @Title: convertNullToInt
	 * @Description: TODO Int 作非空处理
	 * @param @param orgStr
	 * @param @param convertStr
	 * @param @return
	 * @return int
	 ...
	 * 
	 * @Title: convertNullToInt
	 * @Description: TODO Integer 作非空处理
	 * @param @param orgStr
	 * @param @param convertStr
	 * @param @return
	 * @return int
	...
	/**
	 * 
	 * @Title: convertNullToDate
	 * @Description: TODO Date 作非空处理
	 * @param @param orgStr
	 * @param @return
	 * @return Date
	 * @throws
	 ...
	 * @Description: TODO(讀取可配置的jks資源秘鑰文件)
	 * @param @param
	 * @param @param
	 * @param @return
